...
def test_snapshot_operations(db_manager: DatabaseManager) -> None:
...
def test_tracked_page_operations(db_manager: DatabaseManager) -> None:
...
def test_price_history(db_manager: DatabaseManager) -> None:
...
def test_product_groups(db_manager: DatabaseManager) -> None:
...
def test_promotions(db_manager: DatabaseManager) -> None:
